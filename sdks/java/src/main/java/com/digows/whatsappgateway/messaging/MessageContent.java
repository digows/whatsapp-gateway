...
/**
 * Polymorphic normalized content carried by a {@link Message}.
 * Implementations are stable integration contracts and not raw Baileys payload mirrors.
 */
...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(value = InteractiveCarouselMessageContent.class, name = "interactive_carousel"),
